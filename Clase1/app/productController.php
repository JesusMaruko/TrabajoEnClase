...
if(isset($_POST['action'])){
    switch ($_POST['action']){
        case 'create':
            ...
            $productController = new productController();
            $productController->createProduct($name,$slug,$description,$features,$brand_id,$token);
        break;
    }
}
    ...
    class productController
    {
        ...
        public function createProduct($name,$slug,$description,$features,$brand_id,$token)
        {
            $curl = curl_init();
